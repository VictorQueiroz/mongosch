...
export function isEventOnCreate(value: unknown): value is EventOnCreate {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "event.EventOnCreate")) return false;
  return true;
}
...
export function defaultEventOnCreate(params: Partial<EventOnCreateInputParams> = {}): EventOnCreate {
  return EventOnCreate({
    ...params
  });
}
export function compareEventOnCreate(__a: EventOnCreate, __b: EventOnCreate): boolean {
  return true;
}
export function updateEventOnCreate(value: EventOnCreate, _: Partial<EventOnCreateInputParams>) {
  return value;
}
...
export function isEventOnUpdate(value: unknown): value is EventOnUpdate {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "event.EventOnUpdate")) return false;
  return true;
}
...
export function defaultEventOnUpdate(params: Partial<EventOnUpdateInputParams> = {}): EventOnUpdate {
  return EventOnUpdate({
    ...params
  });
}
export function compareEventOnUpdate(__a: EventOnUpdate, __b: EventOnUpdate): boolean {
  return true;
}
export function updateEventOnUpdate(value: EventOnUpdate, _: Partial<EventOnUpdateInputParams>) {
  return value;
}
