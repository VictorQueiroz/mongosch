...
export function isField(value: unknown): value is Field {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "field.Field")) return false;
  if(!(
    "name" in value && ((__v0) => (typeof __v0 === 'string'))(value['name'])
  )) return false;
  if(!(
    "description" in value && ((__v1) => (__v1 === null ? true : ((x) => (typeof x === 'string'))(__v1)))(value['description'])
  )) return false;
  if(!(
    "fieldType" in value && ((__v3) => (isFieldTypeTrait(__v3)))(value['fieldType'])
  )) return false;
  return true;
}
...
export function compareField(__a: Field, __b: Field): boolean {
  return (
     ...
     */
    ((__dp11, __dp12) => __dp11 !== null && __dp12 !== null ? __dp11 === __dp12 : __dp11 === __dp12)(__a['description'],__b['description']) &&
    /**
...
export function updateField(value: Field, changes: Partial<FieldInputParams>) {
  ...
  if(typeof changes['description'] !== 'undefined') {
    if(!(((__dp21, __dp22) => __dp21 !== null && __dp22 !== null ? __dp21 === __dp22 : __dp21 === __dp22)(changes['description'],value['description']))) {
      value = Field({
        ...value,
