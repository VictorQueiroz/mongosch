...
export type FieldTypeStringFlag =
  | Readonly<FieldTypeStringFlagOptional>
  | Readonly<FieldTypeStringFlagMinLength>
  | Readonly<FieldTypeStringFlagMaxLength>
  | Readonly<FieldTypeStringFlagMatchRegularExpression>;
export function isFieldTypeStringFlagTrait(
  value: unknown
): value is FieldTypeStringFlag {
  ...
  if (isFieldTypeStringFlagMatchRegularExpression(value)) return true;
  return false;
}
export function encodeFieldTypeStringFlagTrait(
  __s: ISerializer,
...
export function decodeFieldTypeStringFlagTrait(__d: IDeserializer) {
  ...
  switch (__id) {
    ...
    case -1306615325: {
      const tmp = decodeFieldTypeStringFlagMatchRegularExpression(__d);
      if (tmp === null) return null;
      value = tmp;
      break;
    }
...
export function compareFieldTypeStringFlagTrait(
  __a: FieldTypeStringFlag,
...
export function isFieldTypeStringFlagDefaultValue(
  value: unknown
): value is FieldTypeStringFlagDefaultValue {
  if (
    !(
      typeof value === "object" &&
      value !== null &&
...
export function FieldTypeStringFlagDefaultValue(
...
export function encodeFieldTypeStringFlagDefaultValue(
  __s: ISerializer,
...
export function decodeFieldTypeStringFlagDefaultValue(
  __d: IDeserializer
): FieldTypeStringFlagDefaultValue | null {
  const __id = __d.readInt32();
  /**
   * decode header
   */
...
export function defaultFieldTypeStringFlagDefaultValue(
  params: Partial<FieldTypeStringFlagDefaultValueInputParams> = {}
): FieldTypeStringFlagDefaultValue {
...
export function compareFieldTypeStringFlagDefaultValue(
  __a: FieldTypeStringFlagDefaultValue,
  __b: FieldTypeStringFlagDefaultValue
): boolean {
  return (
    /**
...
export function updateFieldTypeStringFlagDefaultValue(
  value: FieldTypeStringFlagDefaultValue,
  changes: Partial<FieldTypeStringFlagDefaultValueInputParams>
) {
...
export function isFieldTypeStringFlagOptional(
  value: unknown
): value is FieldTypeStringFlagOptional {
  if (
    !(
      typeof value === "object" &&
      value !== null &&
...
export function FieldTypeStringFlagOptional(
...
export function encodeFieldTypeStringFlagOptional(
  __s: ISerializer,
  _: FieldTypeStringFlagOptional
) {
  __s.writeInt32(-1310457092);
}
export function decodeFieldTypeStringFlagOptional(
  __d: IDeserializer
): FieldTypeStringFlagOptional | null {
  const __id = __d.readInt32();
  /**
   * decode header
   */
...
export function defaultFieldTypeStringFlagOptional(
  params: Partial<FieldTypeStringFlagOptionalInputParams> = {}
): FieldTypeStringFlagOptional {
  return FieldTypeStringFlagOptional({
    ...params
  });
}
export function compareFieldTypeStringFlagOptional(
  __a: FieldTypeStringFlagOptional,
  __b: FieldTypeStringFlagOptional
): boolean {
  return true;
}
export function updateFieldTypeStringFlagOptional(
  value: FieldTypeStringFlagOptional,
  _: Partial<FieldTypeStringFlagOptionalInputParams>
) {
  return value;
}
...
export function isFieldTypeStringFlagMinLength(
  value: unknown
): value is FieldTypeStringFlagMinLength {
  if (
    !(
      typeof value === "object" &&
      value !== null &&
...
export function FieldTypeStringFlagMinLength(
...
export function encodeFieldTypeStringFlagMinLength(
  __s: ISerializer,
...
export function decodeFieldTypeStringFlagMinLength(
  __d: IDeserializer
): FieldTypeStringFlagMinLength | null {
  const __id = __d.readInt32();
  /**
   * decode header
   */
...
export function defaultFieldTypeStringFlagMinLength(
  params: Partial<FieldTypeStringFlagMinLengthInputParams> = {}
): FieldTypeStringFlagMinLength {
...
export function compareFieldTypeStringFlagMinLength(
  __a: FieldTypeStringFlagMinLength,
  __b: FieldTypeStringFlagMinLength
): boolean {
  return (
    /**
     * compare parameter value
...
export function updateFieldTypeStringFlagMinLength(
  value: FieldTypeStringFlagMinLength,
  changes: Partial<FieldTypeStringFlagMinLengthInputParams>
) {
  if (typeof changes["value"] !== "undefined") {
    if (!(changes["value"] === value["value"])) {
      value = FieldTypeStringFlagMinLength({
...
export function isFieldTypeStringFlagMaxLength(
  value: unknown
): value is FieldTypeStringFlagMaxLength {
  if (
    !(
      typeof value === "object" &&
      value !== null &&
...
export function FieldTypeStringFlagMaxLength(
...
export function encodeFieldTypeStringFlagMaxLength(
  __s: ISerializer,
...
export function decodeFieldTypeStringFlagMaxLength(
  __d: IDeserializer
): FieldTypeStringFlagMaxLength | null {
  const __id = __d.readInt32();
  /**
   * decode header
   */
...
export function defaultFieldTypeStringFlagMaxLength(
  params: Partial<FieldTypeStringFlagMaxLengthInputParams> = {}
): FieldTypeStringFlagMaxLength {
...
export function compareFieldTypeStringFlagMaxLength(
  __a: FieldTypeStringFlagMaxLength,
  __b: FieldTypeStringFlagMaxLength
): boolean {
  return (
    /**
     * compare parameter value
...
export function updateFieldTypeStringFlagMaxLength(
  value: FieldTypeStringFlagMaxLength,
  changes: Partial<FieldTypeStringFlagMaxLengthInputParams>
) {
  if (typeof changes["value"] !== "undefined") {
    if (!(changes["value"] === value["value"])) {
      value = FieldTypeStringFlagMaxLength({
...
export function isFieldTypeStringFlagMatchRegularExpression(
  value: unknown
): value is FieldTypeStringFlagMatchRegularExpression {
  if (
    !(
      typeof value === "object" &&
      value !== null &&
...
export interface FieldTypeStringFlagMatchRegularExpressionInputParams {
  value: string;
}
export function FieldTypeStringFlagMatchRegularExpression(
...
export function encodeFieldTypeStringFlagMatchRegularExpression(
  __s: ISerializer,
  value: FieldTypeStringFlagMatchRegularExpression
) {
  __s.writeInt32(-1306615325);
  /**
   * encoding param: value
   */
  const __pv0 = value["value"];
...
export function decodeFieldTypeStringFlagMatchRegularExpression(
  __d: IDeserializer
): FieldTypeStringFlagMatchRegularExpression | null {
  const __id = __d.readInt32();
  /**
   * decode header
   */
  if (__id !== -1306615325) return null;
  let value: string;
  /**
   * decoding param: value
   */
...
export function defaultFieldTypeStringFlagMatchRegularExpression(
  params: Partial<FieldTypeStringFlagMatchRegularExpressionInputParams> = {}
): FieldTypeStringFlagMatchRegularExpression {
  return FieldTypeStringFlagMatchRegularExpression({
    value: "",
    ...params
  });
}
export function compareFieldTypeStringFlagMatchRegularExpression(
  __a: FieldTypeStringFlagMatchRegularExpression,
  __b: FieldTypeStringFlagMatchRegularExpression
): boolean {
  return (
    /**
     * compare parameter value
...
export function updateFieldTypeStringFlagMatchRegularExpression(
  value: FieldTypeStringFlagMatchRegularExpression,
  changes: Partial<FieldTypeStringFlagMatchRegularExpressionInputParams>
) {
  if (typeof changes["value"] !== "undefined") {
    if (!(changes["value"] === value["value"])) {
      value = FieldTypeStringFlagMatchRegularExpression({
  ...
  if (
    !(
      ...
      ((__v0) =>
        ...
        Array.from(__v0).every((p) => isFieldTypeStringFlagTrait(p)))(
        value["flags"]
      )
    )
  )
...
export function FieldTypeString(
...
export function encodeFieldTypeString(
  __s: ISerializer,
...
export function decodeFieldTypeString(
  __d: IDeserializer
...
export function defaultFieldTypeString(
  params: Partial<FieldTypeStringInputParams> = {}
): FieldTypeString {
...
export function compareFieldTypeString(
  __a: FieldTypeString,
  __b: FieldTypeString
): boolean {
  return (
      ...
      typeof __originalItem0 === "undefined"
        ...
        : ((__item0) =>
            typeof __item0 === "undefined"
              ? false
              : compareFieldTypeStringFlagTrait(__originalItem0, __item0))(
            Array.from(__b["flags"])[__index0]
          )
    )
  );
}
export function updateFieldTypeString(
  value: FieldTypeString,
  changes: Partial<FieldTypeStringInputParams>
) {
          ...
          typeof __originalItem1 === "undefined"
            ...
            : ((__item1) =>
                typeof __item1 === "undefined"
                  ? false
                  : compareFieldTypeStringFlagTrait(__originalItem1, __item1))(
