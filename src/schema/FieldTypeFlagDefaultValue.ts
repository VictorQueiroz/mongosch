...
export type FieldTypeFlagDefaultValue = Readonly<FieldTypeStringFlagDefaultValue> | Readonly<FieldTypeIntegerFlagDefaultValueDouble> | Readonly<FieldTypeIntegerFlagDefaultValueInt64> | Readonly<FieldTypeIntegerFlagDefaultValueInt32>;
export function isFieldTypeFlagDefaultValueTrait(value: unknown): value is FieldTypeFlagDefaultValue {
...
export function encodeFieldTypeFlagDefaultValueTrait(__s: ISerializer,value: FieldTypeFlagDefaultValue) {
  switch(value._name) {
...
export function decodeFieldTypeFlagDefaultValueTrait(__d: IDeserializer) {
  ...
  __d.rewind(4);
  let value: FieldTypeStringFlagDefaultValue | FieldTypeIntegerFlagDefaultValueDouble | FieldTypeIntegerFlagDefaultValueInt64 | FieldTypeIntegerFlagDefaultValueInt32;
  switch(__id) {
    case -200469876: {
...
export function compareFieldTypeFlagDefaultValueTrait(__a: FieldTypeFlagDefaultValue, __b: FieldTypeFlagDefaultValue) {
  switch(__a._name) {
    case 'fieldTypeString.FieldTypeStringFlagDefaultValue':
      if(__b._name !== "fieldTypeString.FieldTypeStringFlagDefaultValue") return false;
